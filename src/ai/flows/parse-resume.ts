...
const ParseResumeInputSchema = z.object({
  resumeFile: z.string().describe(
      "A resume file, as a data URI that must include a MIME type and use Base64 encoding. Expected format: 'data:<mimetype>;base64,<encoded_data>'. Supported formats are PDF, DOCX, TXT."
    ),
});
